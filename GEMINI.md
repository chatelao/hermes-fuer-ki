# Project Goal
- Create a fusion skill & RACI framework from the best systems RUP, V-Modell-XT, Hermes (CH) and SCRUM 

# Project Milestones
- Download all framework definitions to:
  - /specifications/RUP
  - /specifications/V-Modell-XT
  - /specifications/Hermes
  - /specifications/SCRUM
- Add one more framework of your choice
- Create the unified, AI and human friendly skill systems with roles, deliverables and process
- Emphasis the observability of the AI and the ease of interaction for humans
- The human should be "handler of the start", "handler of conflicts" and "handler of exceptions"
